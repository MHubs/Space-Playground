...
public class FreeFlyCamera : MonoBehaviour
{
    ...
    [SerializeField]
    private Animator settingsButton = null;

    [SerializeField]
    private Animator menuButton = null;
    ...
    private void SetCursorState()
    {
        ...
        if (Input.GetMouseButtonDown(0) && !uiAnimator.GetBool("Open") && settingsButton.GetCurrentAnimatorStateInfo(0).IsName("Normal") && menuButton.GetCurrentAnimatorStateInfo(0).IsName("Normal"))
        {
            _wantedMode = CursorLockMode.Locked;
        }

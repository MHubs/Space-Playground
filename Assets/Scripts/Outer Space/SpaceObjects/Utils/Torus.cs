...
public class Torus : MonoBehaviour {
	...
	public double segmentRadius = 1f;
	public float tubeRadius = 0.1f;
	public int numSegments = 32;
	public int numTubes = 12;

	void Start() {
        segmentRadius = (float)((segmentRadius / 152099995648) * Scale.distScale);
    ...
    public void RefreshTorus() {
        ...
        for (int i = 0; i < numSegments; i++)
        {
            ...
            for (int j = 0; j < numTubes; j++)
            {
                ...
                x = (float)(segmentRadius + tubeRadius * Mathf.Cos(j * tubeSize)) * Mathf.Cos(i * segmentSize);
                z = (float)(segmentRadius + tubeRadius * Mathf.Cos(j * tubeSize)) * Mathf.Sin(i * segmentSize);
